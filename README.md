...
<p align="center">
  ...
  <img alt="checks" src="https://img.shields.io/badge/checks-724-blue">
...
**A verified property:** after uninstall, `settings.json` is **canonically identical** to what it was before (`jq -S`). The installer reverts only the receipt it wrote (`harness-manifest.json`) and touches nothing else. 151 assertions hold that line.
...
| **Installer** | does uninstall restore the original? | **canonically identical**, 151 assertions |
...
| Target | Cases |
|---|---|
| 7 hook verifiers | **255** |
| session-log renderer | **45** |
| installer round trip | **151** assertions |
