...
<p align="center">
  ...
  <img alt="checks" src="https://img.shields.io/badge/checks-768-blue">
...
**A verified property:** after uninstall, `settings.json` is **canonically identical** to what it was before (`jq -S`). The installer reverts only the receipt it wrote (`harness-manifest.json`) and touches nothing else. 189 assertions hold that line.
...
| **Installer** | does uninstall restore the original? | **canonically identical**, 189 assertions |
...
| installer round trip | **189** assertions |
