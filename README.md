...
<p align="center">
  ...
  <img alt="checks" src="https://img.shields.io/badge/checks-738-blue">
...
**A verified property:** after uninstall, `settings.json` is **canonically identical** to what it was before (`jq -S`). The installer reverts only the receipt it wrote (`harness-manifest.json`) and touches nothing else. 159 assertions hold that line.
