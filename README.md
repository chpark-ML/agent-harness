...
<p align="center">
  ...
  <img alt="checks" src="https://img.shields.io/badge/checks-431-blue">
...
| **Installer** | does uninstall restore the original? | **canonically identical**, 92 assertions |
...
| installer round trip | **92** assertions |
| slide claim checker | **36** |
| document references | **55** files + **19** own cases |
| frontmatter | **11** |
